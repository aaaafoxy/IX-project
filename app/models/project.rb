...
class Project < ActiveRecord::Base
  ...
  belongs_to :project_category, class_name: 'ProjectCategory', optional: true
  ...
  validates :project_category_id, presence: true, numericality: { only_integer: true, greater_than: 0 }
