...
module ProjectsHelper
  ...
  def render_project_hierarchy(projects)
    ...
    render_project_nested_lists(projects) do |project|
      ...
      s = ''.html_safe
      s << content_tag(:span, project.project_category.name, class: 'project-category-label') if project.project_category&.name.present?
      s << content_tag(:div, link_to_project(project, {}, :class => classes.uniq.join(' ')) + (project.description.present? ? content_tag('div', textilizable(project.short_description, :project => project), :class => 'wiki description') : ''.html_safe))
      s
    end
  end
